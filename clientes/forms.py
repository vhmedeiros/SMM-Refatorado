...
class ClienteForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "numero_cnpj": forms.TextInput(attrs={"class": "form-control", "placeholder": "Número CNPJ"}),
            "numero_cpf": forms.TextInput(attrs={"class": "form-control", "placeholder": "Número CPF"}),
            "nome_cliente": forms.TextInput(attrs={"class": "form-control", "placeholder": "Nome Cliente"}),
            "nome_razao_social": forms.TextInput(attrs={"class": "form-control", "placeholder": "Nome Razão Social"}),
            "numero_inscricao_estadual": forms.TextInput(attrs={"class": "form-control", "placeholder": "Número Inscrição Estadual"}),
            "numero_inscricao_municipal": forms.TextInput(attrs={"class": "form-control", "placeholder": "Número Inscrição Municipal"}),
            "endereco": forms.TextInput(attrs={"class": "form-control", "placeholder": "Endereço"}),
            "logradouro": forms.TextInput(attrs={"class": "form-control", "placeholder": "Logradouro"}),
            "numero_endereco": forms.TextInput(attrs={"class": "form-control", "placeholder": "Número Endereço"}),
            "complemento": forms.TextInput(attrs={"class": "form-control", "placeholder": "Complemento"}),
            "bairro": forms.TextInput(attrs={"class": "form-control", "placeholder": "Bairro"}),
            "cd_pais": forms.TextInput(attrs={"class": "form-control", "placeholder": "País"}),
            ...
            "contato_usuario": forms.TextInput(attrs={"class": "form-control", "placeholder": "Contato Usuário"}),
            "telefone_usuario": forms.TextInput(attrs={"class": "form-control", "placeholder": "Telefone Usuário"}),
            "email_usuario": forms.TextInput(attrs={"class": "form-control", "placeholder": "Email Usuário"}),
            "status_cliente": forms.Select(attrs={"class": "form-control"}),
            "id_ultimo_servico_pago": forms.TextInput(attrs={"class": "form-control", "placeholder": "ID Último Serviço Pago"}),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        # 🔹 Se a instância já tiver uma data cadastrada, preenche corretamente no formato adequado
